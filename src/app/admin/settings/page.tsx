  ...
  const configs = [
    {
      ...
      items: [
        ...
        { label: "Paymob Integration ID (classic iframe)", value: process.env.PAYMOB_INTEGRATION_ID },
        { label: "Paymob Iframe ID", value: process.env.PAYMOB_IFRAME_ID },
        ...
        { label: "Bank Account Name (display)", value: process.env.BANK_ACCOUNT_NAME },
        { label: "Bank IBAN (display)", value: process.env.BANK_IBAN },
        { label: "Bank Name (display)", value: process.env.BANK_NAME },
      ],
    },
    {
